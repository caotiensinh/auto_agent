...
AUTO_AGENT_BOOTSTRAP_VERSION="0.6.2"
...
UI_TMP="$(mktemp)"
log "CLIENT PHASE 3/3 — persistent history + formatted raw-agent workspace"
download_component scripts/ui_upgrade.sh "$UI_TMP" 'AUTO_AGENT_COMPONENT=ui-v062'
