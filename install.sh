...
AUTO_AGENT_BOOTSTRAP_VERSION="0.6.3"
...
UI_TMP="$(mktemp)"
log "CLIENT PHASE 3/3 — polished direct-output workspace + persistent history"
download_component scripts/ui_upgrade.sh "$UI_TMP" 'AUTO_AGENT_COMPONENT=ui-v063'
